...
class LinkRepository extends BaseRepository
{
    ...
    static public function getAllFrontLinks()
    {
        return Link::all();
    }
    ...
    static public function getFooterLinksSection(){
        return Link::all()->where('link_section_id','=','2');
    }
}