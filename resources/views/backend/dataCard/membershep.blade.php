        ...
        <tbody>
             ...
             <tr>
                @if($data->active == 1)
                    ...
                    <td class="col-xs-9"><img style="max-height: 150px; width: auto;" src="http://www.altarsana.com/public/assets/images/dataCard/{{$data->Membershipphoto}}"></td>

                @else
                    <td class="col-xs-9">{{$data->fullname}} غير عضو بالنادى</td>
                @endif   
            </tr>
