...
<div class="row widget-row">
    ...
    <div class="col-md-2">
     ...
     <div class="col-md-3">
        <!-- BEGIN WIDGET THUMB -->
        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
            <h4 class="widget-thumb-heading">{{trans('backend.visitors')}}</h4>
            <div class="widget-thumb-wrap">
                <i class="widget-thumb-icon bg-red icon-layers"></i>
                <div class="widget-thumb-body">
                    <span class="widget-thumb-subtitle">{{trans('backend.number')}}</span>
                    <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{!! \App\Repositories\StatisticsRepository::countVisitors() !!}">0</span>
                </div>
            </div>
        </div>
        <!-- END WIDGET THUMB -->
