...
class VideosController extends Controller
{
    public function index()
    {
        ...
        return view('backend.media.videos.index', compact('videos'));
    }

    public function create()
    {
        return view('backend.media.videos.create', compact('videos'));
    }
    ...
    public function store(VideoRequest $request, VideoModel $videoModel)
    {
        ...
        return redirect()->route('videosIndex');
    }

    public function edit($id, VideoModel $videoModel)
    {
        $video = $videoModel->find($id);
        return view('backend.media.videos.edit', compact('video'));
    }
