...
<div class="panel panel-default">
    ...
    <table class="table table-striped table-bordered table-hover" >
        ...
        <div class="panel-body">
             <div>
            <h2>صوره شهاده الميلاد</h2>
            <img src="<?=url('public/assets/images/dataCard/'.$data->photoBirthday.'')?>"  alt="{{$data->fullname}}">
            </div>
            <div>
            <h2>صوره الرقم القومى</h2>
            <img src="<?=url('public/assets/images/dataCard/'.$data->IdCardphoto.'')?>"  alt="{{$data->fullname}}">
            </div>
             <div>

            <h2>صوره شخصية</h2>
            <img src="<?=url('public/assets/images/dataCard/'.$data->personalPhoto.'')?>"  alt="{{$data->fullname}}">
            </div>
            <div>
            <h2>صوره بطاقة  العضوية</h2>
            @if($data->active == 1)
                <img src="<?=url('public/assets/images/dataCard/'.$data->Membershipphoto.'')?>"  alt="{{$data->fullname}}">
            @else
                <h2>غير عضو بالنادى</h2>
            @endif
            </div>
        </div>
