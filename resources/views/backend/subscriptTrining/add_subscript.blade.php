        ...
        <div class="col-md-12">
            <div class="portlet box yellow">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>{{trans('backend.addSubscriptionTrainingTime')}}</div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form method="post" action="{{route('postAddSubscriptionTrainingTime')}}" enctype = "multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="price" value="{{old('price')}}" type="text" class="form-control" placeholder="{{trans('backend.price')}}" >
                                @if($errors->has('price'))
                        ...
                        <div class="form-actions">
                            <div class="btn-set pull-left">
                                ...
                                <a class="btn btn-danger" href="{{route('getAllSubscriptionTrainingTime')}}">{{trans('backend.cancel')}}</a>
                            </div>
                        </div>
                    </form>
                    <!-- END FORM-->
