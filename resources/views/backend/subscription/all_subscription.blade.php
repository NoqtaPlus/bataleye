                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>{{$subscriptions->phone}}</td>
                                 ...
                                 <td>
                                <div class="clearfix">
                                    <form class="form-delete-c" method="post" onclick="return confirm('<?php echo trans('backend.confirmDelete');?>')" action="{{route('deleteSubscriptionById',['id'=>$subscriptions->id])}}">
                                        {{ csrf_field() }}
